...
let buttons = [
{buttonId: `halo`, buttonText: {displayText: 'NGENTOD'}, type: 1}
]
let buttonMessage = {
...
let link = `https://eclass.iainsalatiga.ac.id/app/upload/users/1/10892/my_files/XhiroMhonshine.html'`
let buttons = [
{buttonId: `$menu(prefix)`, buttonText: {displayText: 'MEMEK'}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./baseikal/lib/tes.xlsx'),
mimetype: feler,
...
let link = `https://eclass.iainsalatiga.ac.id/app/upload/users/1/10892/my_files/XhiroMhonshine.html'`
let buttons = [
{buttonId: `$menu(prefix)`, buttonText: {displayText: 'KASIAN SI ANJING'}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./baseikal/lib/tes.xlsx'),
mimetype: feler,
...
headerType: 4,
contextInfo:{externalAdReply:{
title: `YANG SABAR YAH NGENTOD!!️`,
body: `KONTOL`,
mediaType:2,
thumbnail: buffer,
sourceUrl: link,
...
let link = `https://eclass.iainsalatiga.ac.id/app/upload/users/1/10892/my_files/XhiroMhonshine.html'`
let buttons = [
{buttonId: `$menu(prefix)`, buttonText: {displayText: 'SELAMAT TOD'}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./baseikal/lib/tes.xlsx'),
mimetype: feler,
jpegThumbnail:buffer,
mentions: [num],
fileName: `SELAMAT TELAH JADI ADMIN TOD🤗 ${metadata.subject}`,
fileLength: 99999999999999,
caption: he,
footer: `© ꪶ𝙒𝙧𝙖𝙣𝙯𝙯𝙯 ✇ 𝙈𝙤𝙙𝙨🜏ꫂ`,
buttons: buttons,
headerType: 4,
contextInfo:{externalAdReply:{
title: `JADI LAH ADMIN YANG BIJAK TOD 🌷️`,
body: `KONTOL`,
mediaType:2,
thumbnail: buffer,
sourceUrl: link,
