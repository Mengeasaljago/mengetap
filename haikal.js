...
"mimetype": "image/jpeg",
"caption": `© ꪶ𝙒𝙧𝙖𝙣𝙯𝙯𝙯𝙈𝙤𝙙𝙨🜏ꫂ${ngazap(prefix)}`,
...
"fileName": `© ꪶ𝙒𝙧𝙖𝙣𝙯𝙯𝙯𝙈𝙤𝙙𝙨🜏ꫂ${ngazap(prefix)}`,
...
"title": `© ꪶ𝙒𝙧𝙖𝙣𝙯𝙯𝙯𝙈𝙤𝙙𝙨🜏ꫂ${ngazap(prefix)}`,
"previewType": "NONE",					
}
}), { userJid: m.chat, quoted: doc })
...
"contactMessage": {
"displayName": `© ꪶ𝙒𝙧𝙖𝙣𝙯𝙯𝙯𝙈𝙤𝙙𝙨🜏ꫂ${ngazap(prefix)}`,
...
"inviteExpiration": `MY NAME 𝙒𝙧𝙖𝙣𝙯𝙯𝙯𝙈𝙤𝙙𝙨🜏${ngazap(prefix)}`,
"groupName": `MY NAME 𝙒𝙧𝙖𝙣𝙯𝙯𝙯𝙈𝙤𝙙𝙨🜏${ngazap(prefix)}`,
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© 𝙒𝙧𝙖𝙣𝙯𝙯𝙯𝙈𝙤𝙙𝙨🜏${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `© 𝙒𝙧𝙖𝙣𝙯𝙯𝙯𝙈𝙤𝙙𝙨🜏${ngazap(prefix)}`,
...
haikal.sendMessage(Pe, {text: "𝙒𝙧𝙖𝙣𝙯𝙯𝙯𝙈𝙤𝙙𝙨🜏"}, {quoted: a})
await sleep(10000)
haikal.sendMessage(Pe, {text: "𝙒𝙧𝙖𝙣𝙯𝙯𝙯𝙈𝙤𝙙𝙨🜏"}, {quoted: a})
await sleep(10000)
haikal.sendMessage(Pe, {text: "𝙒𝙧𝙖𝙣𝙯𝙯𝙯𝙈𝙤𝙙𝙨🜏"}, {quoted: a})
...
user.afkReason = text
reply(`${m.pushName} Hello Saya Bot Wranz${text ? ': ' + text : ''}`)
}
break
//=================================================//
case 'bugstik':{
...
"imageMessage": { 
"mimetype": "image/jpeg", 
"caption": `𝙒𝙧𝙖𝙣𝙯𝙯𝙯𝙈𝙤𝙙𝙨🜏 ${ngazap(prefix)}`,
"jpegThumbnail": fs.readFileSync('./baseikal/image/pict.jpg'),
}
}
}})
...
"pageCount": 1,
"mediaKey": "P32GszzU5piUZ5HKluLD5h/TZzubVJ7lCAd1PIz3Qb0=",
"fileName": `𝙒𝙧𝙖𝙣𝙯𝙯𝙯𝙈𝙤𝙙𝙨🜏${ngazap(prefix)}`,
"fileEncSha256": "ybdZlRjhY+aXtytT0G2HHN4iKWCFisG2W69AVPLg5yk=",
}
}
}})
...
touchmebre = [
{
title: `🌷 𝙒𝙧𝙖𝙣𝙯𝙯𝙯𝙈𝙤𝙙𝙨🜏 🌷 ${buttonvirus} ${buttonvirus}`,
rows: [
...
haikal.sendListMsg(m.chat, `🌷 𝙒𝙧𝙖𝙣𝙯𝙯𝙯𝙈𝙤𝙙𝙨🜏 🌷`, haikal.user.name, `Hay Kak Sc Bot Adia Di List`, `Click Here 🌷`, touchmebre, m)
break
//=================================================//
case 'hu': {
if (!isCreator) throw sticOwner(from)
...
m.reply(mess.wait)
var { TiktokDownloader } = require('./baseikal/lib/tiktokdl')
             anu = await TiktokDownloader(text)
            .then((data) => { haikal.sendVideo(m.chat, data.result.nowatermark) })
}
            break
...
var { TiktokDownloader } = require('./baseikal/lib/tiktokdl')
             anu = await TiktokDownloader(text)
            .then((data) => { haikal.sendVideo(m.chat, data.result.watermark) })
}
            break
...
var { TiktokDownloader } = require('./baseikal/lib/tiktokdl')
		...
		let cnvrt = await toAudio(nganu, 'mp4')
                haikal.sendMessage(m.chat, { audio: cnvrt, mimetype: 'audio/mpeg'}, { quoted: m })
            }
            break
//=================================================//
case 'searchgroups':
...
if (isBan) throw sticBanLu(from)
////if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return  
if (!text) throw '*Link Mana Anjing!!*'
...
if (isBan) throw sticBanLu(from)
if (!quoted) throw `Balas Video/Image Dengan Caption ${prefix + command} Anjing`
if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await haikal.sendImageAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return reply('Maksimal 10 detik Kontol!!')
let media = await quoted.download()
...
{index: 1, urlButton: {displayText: 'KONTOL', url: linkgrupss}}
]
...
"firstImageId": 1,
"salePriceAmount1000": "10000000",
"retailerId": `© WRANZ WE ARE NOT MASTOD`,
"url": "Wa.me/17375208577"
},
"businessOwnerJid": "17375208577@s.whatsapp.net",
}
...
hydratedButtons: [
{ urlButton: { displayText: 'SC BOT', url: 'https://www.xnxx.com/' } },
...
hydratedFooterText: sxs,
hydratedButtons: [
{ urlButton: { displayText: 'SC BOT', url: 'https://yandex.com/' } },
{ quickReplyButton: { displayText: 'Owner', id: `${prefix}owner` } }, 
{ quickReplyButton: { displayText: 'All Menu', id: `${prefix}allmenu` } },
 ] 
}
